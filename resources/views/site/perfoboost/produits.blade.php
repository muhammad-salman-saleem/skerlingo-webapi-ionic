...
@section('content')
    <!-- start section -->
    <section class="overlap-height bg-fast-blue">
        <div class="container">
            <div class="row">
                <div
        ...
        <div class="container-fluid">
            <div class="row overlap-section align-items-center justify-content-end z-index-0">
                <div class="col-12 position-absolute left-minus-50px p-0 tilt-box d-none d-md-block"
                    ...
                    <span
                        class="alt-font text-black font-weight-700 opacity-1 letter-spacing-minus-7px text-big">{{ $rubrique->label }}</span>
                </div>
                <div class="col-12 col-md-9 px-0">
                    <figure class="sixteen-nine-img">
                        <img src="{{ $rubrique->getIcone() }}" alt="" class="w-100" />
                    </figure>
                </div>
            </div>
        </div>
