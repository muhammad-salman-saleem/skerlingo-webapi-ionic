    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
      ...
      >
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
          <!--begin::Page Title-->
          <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Rubriques du blog</h5>
          <div class="d-flex align-items-center" id="kt_subheader_search">
            <span
              class="text-dark-50 font-weight-bold"
              id="kt_subheader_total"
            >{{rubriques.length}} Rubriques du blog</span>
            <form class="ml-5">
        ...
        <div class="d-flex align-items-center">
          ...
          >
            <i class="ki ki-plus icon-1x"></i> Ajouter une rubrique
          </a>
        </div>
        <!--end::Toolbar-->
      </div>
        ...
        <div class="card card-custom gutter-b">
          <div class="card-header">
            <div class="card-title">
              <h3 class="card-label">Rubriques du blog</h3>
            </div>
          </div>
