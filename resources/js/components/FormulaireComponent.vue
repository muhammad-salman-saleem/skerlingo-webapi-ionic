    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
      ...
      >
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
          <!--begin::Page Title-->
          <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Formulaires</h5>
          <div class="d-flex align-items-center" id="kt_subheader_search">
            <span
              class="text-dark-50 font-weight-bold"
              id="kt_subheader_total"
            >{{formulaires.length}} Formulaires</span>
            <form class="ml-5">
        ...
        <div class="card card-custom gutter-b">
          <div class="card-header">
            <div class="card-title">
              <h3 class="card-label">Formulaires</h3>
            </div>
          </div>
          <div class="card-body p-5 pt-0">
            <v-card style="box-shadow: none;">
              <v-data-table class="table" :headers="headers" :items="formulaires" :search="search">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 v-if="!rubrique.id" class="modal-title" id="exampleModalLabel">Ajouter une rubrique.</h5>
            <h5 v-if="rubrique.id" class="modal-title" id="exampleModalLabel">Modifier une rubrique</h5>
  ...
  methods: {
    fetch() {
      axios
        ...
        .then(
          function (response) {
            this.formulaires = response.data.formulaires;
