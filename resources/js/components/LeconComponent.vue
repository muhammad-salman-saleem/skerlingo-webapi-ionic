    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
      ...
      >
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
          <!--begin::Page Title-->
          <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Leçons</h5>
          <div class="d-flex align-items-center" id="kt_subheader_search">
            <span
              class="text-dark-50 font-weight-bold"
              id="kt_subheader_total"
            >{{rubriques.length}} Leçons</span>
            <form class="ml-5">
          ...
          <form @submit.prevent="saveRubrique" class="mb-3">
            <div class="modal-body">
              ...
              <div class="form-group mt-2">
                <label for="recipient-name" class="form-control-label">Letter</label>
                <input
                  type="text"
                  class="form-control"
                  :placeholder="'Letter'"
                  v-model="rubrique.letter"
                />
              </div>
              ...
              >
                <div class="form-group mt-2">
                  ...
                  <input
                    type="text"
                    class="form-control"
                    :placeholder="'Sub title '+l.value "
                    v-model="rubrique['introduction_'+l.value]"
                  />
                </div>
              </div>
