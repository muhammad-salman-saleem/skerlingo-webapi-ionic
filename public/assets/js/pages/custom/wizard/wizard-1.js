			...
			_formEl,
			{
				fields: {
					designation: {
						validators: {
							notEmpty: {
								message: 'Désignation du produit est obligatoire !'
							}
						}
					},
					prix: {
					...
					nom_complet: {
						validators: {
							notEmpty: {
								message: 'Nom & prénom du destinataire est obligatoire !'
							}
						}
					},
					telephone: {
						validators: {
							notEmpty: {
								message: 'Numéro de téléphone destinataire est obligatoire !'
							}
						}
					}
				},
